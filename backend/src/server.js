...
function buildInput({ paraText, pageContext, userPrompt, imageData, storyContext }) {
  ...
  return [{
    ...
    content: [
      {
        type: 'input_text',
        text: `選択された漫画の画像内の台詞やナレーションを読み取り、日本語学習者にわかりやすく説明してください。文章の意味、表現のニュアンス、ここまでの物語との関係だけに集中してください。構図、人物の外見・服装・姿勢、背景、物の配置など、画像そのものの描写はしないでください。ただし、台詞の意味を理解するために不可欠な視覚情報だけは簡潔に触れてもかまいません。読めない箇所やOCRと矛盾する箇所は推測で断定しないでください。
